        ...
        <div class="text-sm">
          <div>
            <input
              class="w-100% p-3"
              v-model="inputName"
              placeholder="请输入标题（不填将自动生成）"
            />
          </div>
          <div
            class="bg-white border-t border-hex-ccc flex justify-between py-3 px-2"
          >
            <div>签到列表是否可见</div>
          ...
          >
            <span>活动时长</span>
            <span class="text-hex-1989FA" @click="changePopShow"
              >{{ durationTime }}<van-icon name="arrow-down"
            /></span>
            <van-popup

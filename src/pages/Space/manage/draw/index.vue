...
const add = (flag) => {
  if (flag) draw_count1.value = draw_count1.value + 1;
  else if (flag == 0) draw_count2.value = draw_count2.value + 1;
};
const sub = (flag) => {
  if (flag && draw_count1.value > 1) draw_count1.value = draw_count1.value - 1;
...
<template>
  <div class="bg-gray-100 p-3">
    ...
    <div class="bg-white rounded mt-3 p-3 text-sm">
      <div
        class="flex justify-between items-center border-b-1 border-hex-C9C9C9 py-1"
      >
        <span>设置抽签选项可抽次数</span>
        <span><van-switch v-model="checked" size="1.5em" /></span>
      </div>
      <div
        class="flex justify-between items-center border-b-1 border-hex-C9C9C9 py-3"
      >
        <span>
        ...
        <span>
          <i class="bg-hex-D7D7D7 color-hex-633333 text-xs p-1" @click="sub(1)">
            <van-icon name="minus" />
          </i>
          ...
          <i
            class="bg-hex-D7D7D7 color-hex-633333 ml-2 text-xs p-1"
            @click="add(1)"
          >
            <van-icon name="plus" />
          </i>
      ...
      >
        ...
        <span>
          <i class="bg-hex-D7D7D7 color-hex-633333 text-xs p-1" @click="sub(0)">
            <van-icon name="minus" />
          </i>
          <i class="bg-hex-D7D7D7 color-hex-633333 ml-2 py-0.7 px-3 text-sm">{{
            draw_count2
      ...
      <div
        class="flex justify-between items-center border-b-1 border-hex-C9C9C9 text-blue-800 py-3"
      >
        <span>

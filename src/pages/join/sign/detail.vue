    ...
    <div class="bg-white m-15px">
      <div class="signInfoItem justify-between flex">
        ...
        >
          ...
          <span style="color: #8a8a8a" class="m-auto text-xs"
            >&nbsp;&nbsp;基本配置&nbsp;&nbsp;</span
          >
        </div>
        <div class="flex">
          <van-switch v-model="signSwitchChecked" class="m-auto" size="1em" />
          <span class="text-dark-800 font-600 m-auto text-xs"
            >&nbsp;&nbsp;&nbsp;&nbsp;签到中</span
          >
        </div>
      </div>
      ...
      <div class="border border-solid p-10px h-45px flex">
        ...
        <van-radio-group
          ...
          class="flex text-sm"
        >
          <van-radio name="1" icon-size="0.875rem"> 可见 </van-radio>
          <van-radio name="2" icon-size="0.875rem"> 不可见 </van-radio>
        </van-radio-group>
      </div>
    </div>
    <div

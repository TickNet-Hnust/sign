      ...
      >
        ...
        >
          ...
          <div style="display: flex; justify-content: space-between">
            ...
            <span class="text-xs">
              <span v-if="!item.ended" class="bg-hex-41BD62 text-white px-2 py-1 rounded">{{ item.type }}中</span>
              <span v-if="item.ended" class="bg-hex-C9C9C9 text-hex-7E7E7E px-2 py-1 rounded">{{ item.type }}中</span>
            </span>
          </div>
